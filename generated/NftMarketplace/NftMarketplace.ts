...
export class NftMarketplace__ItemBought extends ethereum.Event {
  get params(): NftMarketplace__ItemBought__Params {
    return new NftMarketplace__ItemBought__Params(this);
  }
}

export class NftMarketplace__ItemBought__Params {
  _event: NftMarketplace__ItemBought;

  constructor(event: NftMarketplace__ItemBought) {
    this._event = event;
  }
...
export class NftMarketplace__ItemCancelled extends ethereum.Event {
  get params(): NftMarketplace__ItemCancelled__Params {
    return new NftMarketplace__ItemCancelled__Params(this);
  }
}

export class NftMarketplace__ItemCancelled__Params {
  _event: NftMarketplace__ItemCancelled;

  constructor(event: NftMarketplace__ItemCancelled) {
    this._event = event;
  }
...
export class NftMarketplace__ItemListed extends ethereum.Event {
  get params(): NftMarketplace__ItemListed__Params {
    return new NftMarketplace__ItemListed__Params(this);
  }
}

export class NftMarketplace__ItemListed__Params {
  _event: NftMarketplace__ItemListed;

  constructor(event: NftMarketplace__ItemListed) {
    this._event = event;
  }
...
export class NftMarketplace__WithdrewProceeds extends ethereum.Event {
  get params(): NftMarketplace__WithdrewProceeds__Params {
    return new NftMarketplace__WithdrewProceeds__Params(this);
  }
}

export class NftMarketplace__WithdrewProceeds__Params {
  _event: NftMarketplace__WithdrewProceeds;

  constructor(event: NftMarketplace__WithdrewProceeds) {
    this._event = event;
  }
...
export class NftMarketplace extends ethereum.SmartContract {
  ...
  getMinPrice(): BigInt {
    let result = super.call("getMinPrice", "getMinPrice():(uint256)", []);

    return result[0].toBigInt();
  }

  try_getMinPrice(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("getMinPrice", "getMinPrice():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  getProceedsEarned(seller: Address): BigInt {
    let result = super.call(
      "getProceedsEarned",
      "getProceedsEarned(address):(uint256)",
  ...
  try_getProceedsEarned(seller: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "getProceedsEarned",
      "getProceedsEarned(address):(uint256)",
      [ethereum.Value.fromAddress(seller)]
